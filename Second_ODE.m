...
for j=2:steps+1
    ...
    k1(j-1,1)=h*f( x(j-1), y1(j-1), y2(j-1) );
    
    m1(j-1,1)=h*g( x(j-1), y1(j-1), y2(j-1) );
    
    k2(j-1,1)=h*f( x(j-1)+h/2, y1(j-1)+0.5*k1(j-1), y2(j-1)+0.5*m1(j-1) );
    
    m2(j-1,1)=h*g( x(j-1)+h/2, y1(j-1)+0.5*k1(j-1), y2(j-1)+0.5*m1(j-1) );
  
    k3(j-1,1)=h*f( x(j-1)+h/2, y1(j-1)+0.5*k2(j-1), y2(j-1)+0.5*m2(j-1) );
    
    m3(j-1,1)=h*g( x(j-1)+h/2, y1(j-1)+0.5*k2(j-1), y2(j-1)+0.5*m2(j-1) );
    
    k4(j-1,1)=h*f( x(j-1)+h, y1(j-1)+k3(j-1), y2(j-1)+m3(j-1) );
    
    m4(j-1,1)=h*g( x(j-1)+h, y1(j-1)+k3(j-1), y2(j-1)+m3(j-1) );
    
    y2(j,1)=y2(j-1)+(1/6)*(k1(j-1)+2*k2(j-1)+2*k3(j-1)+k4(j-1));
    
    y1(j,1)=y1(j-1)+(1/6)*(m1(j-1)+2*m2(j-1)+2*m3(j-1)+m4(j-1));
end
rk4=vpa([x y1 y2],5)
